...
type standardFanUnitBcm2712 struct {
...
func (fu standardFanUnitBcm2712) Kind() FanUnitKind {
...
func (fu standardFanUnitBcm2712) Run(ctx context.Context) error {
	var err error
...
func (fu *standardFanUnitBcm2712) handleFanEdge(evt gpiod.LineEvent) {
...
func (fu *standardFanUnitBcm2712) SetFanSpeedPercent(_ context.Context, percent uint8) error {
	return fu.SetFanSpeedPwmFunc(percent)
}

func (fu *standardFanUnitBcm2712) SetLed(_ context.Context, _ led.Color) error {
	return nil
}

func (fu *standardFanUnitBcm2712) FanSpeedRPM(_ context.Context) (float64, error) {
	return fu.fanRpm, nil
}

func (fu *standardFanUnitBcm2712) WaitForButtonPress(ctx context.Context) error {
	<-ctx.Done()
	return ctx.Err()
}

func (fu *standardFanUnitBcm2712) AirFlowTemperature(_ context.Context) (float32, error) {
	return -1 * math.MaxFloat32, nil
}

func (fu *standardFanUnitBcm2712) Close() error {
	return nil
}
